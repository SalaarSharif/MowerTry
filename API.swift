...
public struct CreateSvcReqInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, custUName: String? = nil, provUName: String? = nil, svcLat: Double? = nil, svcLng: Double? = nil, svcAddr: String? = nil,accepted: Bool? = nil) {
    graphQLMap = ["id": id, "custUName": custUName, "provUName": provUName, "svcLat": svcLat, "svcLng": svcLng, "svcAddr": svcAddr, "accepted": accepted]
  }
...
public struct UpdateSvcReqInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, custUName: String? = nil, provUName: String? = nil, svcLat: Double? = nil, svcLng: Double? = nil, svcAddr: String? = nil,accepted: Bool? = nil) {
    graphQLMap = ["id": id, "custUName": custUName, "provUName": provUName, "svcLat": svcLat, "svcLng": svcLng, "svcAddr": svcAddr,"accepted": accepted]
  }
